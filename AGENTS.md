...
> Grok Build, Claude, etc.) generate code that matches this style by default. Rooted in
> data-oriented design, procedural programming, and a performance-first mindset.
>
> Companion reference: `beautiful-code.md` (repo root of this agent-config profile)
