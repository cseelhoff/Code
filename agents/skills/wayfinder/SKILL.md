...
- **Prototype** (HITL): Raise the fidelity of the discussion by making a cheap, rough, concrete artifact to react to — an outline, a rough take, a stub, or UI/logic code as a cheap throwaway sketch (no dedicated prototype skill in this profile). Links the prototype as an asset. Use when "how should it look" or "how should it behave" is the key question.
...
Source: https://github.com/mattpocock/skills (skills/engineering/wayfinder) — MIT.
